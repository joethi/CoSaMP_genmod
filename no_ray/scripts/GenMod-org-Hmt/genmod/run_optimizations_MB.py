...
def run_genmod(start_iter, stop_iter, fn, d, p, data_all, indices, outdir,Nt,
    ...
    for j in np.linspace(start_iter, stop_iter,
        ...
        for k in range(Nvlrp):
            ...
            dmo = dm.DecayModel(d, p, outdir, p_z0,Nt, model='expalg')
        ...
        # df_prms.to_csv(f'{outdir}/{fn}_genmod_zstr_{j}.csv', index=False)
