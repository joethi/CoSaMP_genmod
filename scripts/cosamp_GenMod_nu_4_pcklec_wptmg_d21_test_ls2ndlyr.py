...
if args.debug_act==1:
    ...
    avtnlst =['None'  if tune_sg==0 else tune.choice([nn.Sigmoid()]) for a_m in range(Nlhid)]    
else:
...
#%%====================calculate the omp coefficients on the residual signal================
            ...
            c_hat_bst_2nd = (la.inv(Psi_active_2nd_T @ Psi_active_2nd) @ Psi_active_2nd_T @ u_data[optim_indices]).flatten()
            c_omp_bst[Lambda_bst] = c_hat_bst_2nd 
            #===============================================================================
            #===============================================================================
