...
out_dir_ini = '../output/titan_ppr/Nrp30'
...
print(df_params)
f = open(f'{out_dir_ini}/1dellps_indices_n={N}_ini.csv', 'w')
...
f.close()
index_file = f'{out_dir_ini}/1dellps_indices_n={N}_ini.csv'
#index_file = f'{out_dir_ini}/ini/ind/indices_genmod_omp_N=100.csv'
#
...
#            if i==0:
#                trn_ind_nw = pd.read_csv(f'{out_dir_ini}/ini/tvceff/trn_ind_p3d78_75_gsdwn.csv').to_numpy().flatten()
#                val_ind_nw = pd.read_csv(f'{out_dir_ini}/ini/tvceff/val_ind_p3d78_75_gsdwn.csv').to_numpy().flatten()
            # elif i==1:  
