...
import sys
sys.path.append('/home/jothi/GenMod-org-Hmt')
...
parser.add_argument('--n_runs',dest='n_rep',type=int,help='Number of sample replications')
...
N_rndsmp = N_y #FIXME#np.size(u_data) To generate same results as SO.
