...
nz = d+1   ##CHANGE HERE FOR THE exp/algebraic model.
...
index_file = f'{out_dir_ini}/ini/ind/indices_omp_N=300_wrkdomp_modified.csv'
# index_file = f'{out_dir_ini}/P=3/test/1dellps_indices_n=100_tst.csv'
# index_file = f'{out_dir_ini}/ini/ind/indices_foromp_N=300_tst.csv'
#%%Change the optim to valid from the omp indices(I don't split valid and optim for omps)
# inputFileName = index_file
# outputFileName = f'{out_dir_ini}/indices_omp_N=300_modified.csv'
