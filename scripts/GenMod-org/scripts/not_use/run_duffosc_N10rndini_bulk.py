...
out_dir_ini = 'C:/Users/jothi/OneDrive - UCB-O365/PhD/UQ_research/ACCESS_UQ/GenMod-NN/GenMod-org/output/duff_osc_ppr'
...
st = time.time()
#%%
data = sio.loadmat(r'C:\Users\jothi\OneDrive - UCB-O365\PhD\UQ_research\ACCESS_UQ\GenMod-NN\GenMod-org\data\duff_osc\duff_osc_data.mat')
y_data = data['y']
u_data1 = data['u']
...
out_dir_ini = f'C:/Users/jothi/OneDrive - UCB-O365/PhD/UQ_research/ACCESS_UQ/GenMod-NN/GenMod-org/output/duff_osc_ppr/d=3/p=9/N={N}'
