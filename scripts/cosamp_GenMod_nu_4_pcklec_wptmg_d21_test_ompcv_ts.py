...
parser.add_argument('--cini_fl',dest='cht_ini_fl',default='/home/jothi/CoSaMP_genNN/output/titan_ppr/results/d78_ppr/ref_dbg/j3_rprdc4/cini_1dellps_n=80_genmod_S=8_1_j3_c0.csv',type=str,help='file name with the path for initial omp coefficients for reproducing/debugging')
